...
public interface MirrorApplicationService
{
    ...
    /**
     * Copies the given installable units, their dependencies and the associated artifacts into the
     * destination p2 repository.
     * 
     ...
     *            must be a directory, which may be empty.
     ...
     *            units form the source repositories should be passed via this parameter.
